...
{
    public partial class FavAdDetails : Form
    {
        private int adID;
        private int userID = (int)GlobalSettings.UserID; // Kullanıcı ID'si, burada statik bir değer kullandık. Gerçek uygulamada oturum yönetimi ile alınmalı.
